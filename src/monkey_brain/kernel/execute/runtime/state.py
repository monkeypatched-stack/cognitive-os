...
def _safe_phase(value: str) -> ExecutionPhase:
    try:
        return ExecutionPhase(value)
    except ValueError:
        return ExecutionPhase.INITIALIZED
...
class CapabilityResult:
    """Extended result for workload capabilities — wraps icapability.CapabilityResult.
