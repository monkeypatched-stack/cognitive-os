...
class TestReporter:
    ...
    def console_report(self, results: list[dict[str, Any]], title: str = "Test Report") -> str:
        ...
        report = "\n".join(lines)
        self._reports.append({"type": "console", "content": report})
        return report

    def json_report(self, results: list[dict[str, Any]], title: str = "Test Report") -> dict[str, Any]:
