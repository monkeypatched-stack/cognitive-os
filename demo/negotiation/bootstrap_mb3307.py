"""MB-3307 — Cooperative Planning: World Bootstrap.

Real-API-only. Warehouse Worker, Inventory Robot, Driver, Support
Agent, plus a Customer whose real order needs a fulfillment plan.
"""
